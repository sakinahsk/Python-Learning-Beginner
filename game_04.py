# I learn from https://coding-grace-guide.readthedocs.io/en/latest/guide/lessonplans/beginners-python-text-based-adventure.html
...
def red_door_room():
    ...
    If a player types "flee" as an answer, player returns to the room
    with two doors, otherwise the player dies.
    '''
    ...
    if "flee" in next_move:
        ...
        print("It eats you. Well, that was tatsy!")
...
def start_adventure():
    ...
    if door_picked == "red":
        # This calls a function that contain stuff that happens in red_door_room
        red_door_room()
